import { BarChart3, CalendarDays, ClipboardCheck, ListChecks, PenLine } from "lucide-react";
      ...
      <div className="mx-auto grid max-w-md grid-cols-4 gap-1">
        {items.map((item) => (
          <NavLink
            ...
            className={({ isActive }) =>
              cn(
                "flex h-14 flex-col items-center justify-center gap-1 rounded-md text-xs font-semibold text-muted-foreground",
